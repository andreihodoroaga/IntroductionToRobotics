...
// LCD menu stuff
Menu lcdMenu(lcd, joystickManager, eepromHandler);
byte bombChar[] = {
  B00010,
  B00100,
  B01110,
...
void applyConfigurationSettings() {
  analogWrite(LCDIntensityPin, eepromHandler.getLcdBrightness());
  lc.setIntensity(0, eepromHandler.getMatrixBrightness());
}
